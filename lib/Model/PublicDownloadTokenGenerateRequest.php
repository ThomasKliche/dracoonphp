...
/**
 * PublicDownloadTokenGenerateRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PublicDownloadTokenGenerateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PublicDownloadTokenGenerateRequest';
     ...
     * Sets password
     *
     * @param string $password Password (only for password-protected shares)
     *
     * @return $this
     */
