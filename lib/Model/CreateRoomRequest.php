...
/**
 * CreateRoomRequest Class Doc Comment
 *
 * @category Class
...
class CreateRoomRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateRoomRequest';
     ...
     * Sets parent_id
     *
     * @param int $parent_id Parent room ID or `null` to create a top level room (default: `0`)
     *
     * @return $this
     */
