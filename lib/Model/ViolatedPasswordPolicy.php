...
/**
 * ViolatedPasswordPolicy Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ViolatedPasswordPolicy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ViolatedPasswordPolicy';
     ...
     * Sets name
     *
     * @param string $name Name of the violated password policy
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message Message from password validator
     *
     * @return $this
     */
