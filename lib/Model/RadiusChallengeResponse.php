...
/**
 * RadiusChallengeResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RadiusChallengeResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RadiusChallengeResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reply_state'] = isset($data['reply_state']) ? $data['reply_state'] : null;
    ...
    {
        return $this->container['reply_state'];
    }

    /**
     * Sets reply_state
     *
     * @param string $reply_state For RADIUS Access-Challenge If a `replyState` is returned, it must be included as `state` in the following request.
     *
     * @return $this
     */
    public function setReplyState($reply_state)
    {
        $this->container['reply_state'] = $reply_state;
     ...
     * Sets reply_message
     *
     * @param string $reply_message RADIUS Reply-Message Instruction how to handle the situation.
     *
     * @return $this
     */
