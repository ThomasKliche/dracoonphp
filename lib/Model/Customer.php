...
class Customer implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'user_max' => 'setUserMax',
        'user_used' => 'setUserUsed',
        'created_at' => 'setCreatedAt',
        'lock_status' => 'setLockStatus',
        'is_locked' => 'setIsLocked',
        'trial_days_left' => 'setTrialDaysLeft',
    ...
    protected static $getters = [
        ...
        'user_max' => 'getUserMax',
        'user_used' => 'getUserUsed',
        'created_at' => 'getCreatedAt',
        'lock_status' => 'getLockStatus',
        'is_locked' => 'getIsLocked',
        'trial_days_left' => 'getTrialDaysLeft',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['user_used'] = isset($data['user_used']) ? $data['user_used'] : null;
        ...
        $this->container['trial_days_left'] = isset($data['trial_days_left']) ? $data['trial_days_left'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['user_used'] === null) {
            $invalidProperties[] = "'user_used' can't be null";
        }
     ...
     * Sets quota_used
     *
     * @param int $quota_used Used amount of disc space in bytes
     *
     * @return $this
     */
     ...
     * @return int
     */
    public function getUserUsed()
    {
        return $this->container['user_used'];
    }

    /**
     * Sets user_used
     *
     * @param int $user_used Number of users which are already allocated.
     *
     * @return $this
     */
    public function setUserUsed($user_used)
    {
        $this->container['user_used'] = $user_used;
    ...
    /**
     * Gets trial_days_left
     *
     * @return int
     */
    public function getTrialDaysLeft()
    {
        return $this->container['trial_days_left'];
    }

    /**
     * Sets trial_days_left
     *
     * @param int $trial_days_left Number of days left for trial period (relevant only for type `demo`) (not used)
     *
     * @return $this
     */
    public function setTrialDaysLeft($trial_days_left)
    {
        $this->container['trial_days_left'] = $trial_days_left;
     ...
     * Sets last_login_at
     *
     * @param \DateTime $last_login_at Date of last seen login for the customer
     *
     * @return $this
     */
