...
/**
 * UserKeyPairContainer Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserKeyPairContainer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserKeyPairContainer';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['private_key_container'] === null) {
            $invalidProperties[] = "'private_key_container' can't be null";
        }
        if ($this->container['public_key_container'] === null) {
            $invalidProperties[] = "'public_key_container' can't be null";
        }
