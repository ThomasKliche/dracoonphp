...
/**
 * CreateActiveDirectoryConfigRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateActiveDirectoryConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateActiveDirectoryConfigRequest';
     ...
     * Sets user_import
     *
     * @param bool $user_import Determines if a DRACOON account is automatically created for a new user who successfully logs on with his / her AD / IDP account. (default: `false`)
     *
     * @return $this
     */
     ...
     * Sets use_ldaps
     *
     * @param bool $use_ldaps Determines whether LDAPS should be used instead of plain LDAP. (default: `false`)
     *
     * @return $this
     */
