...
/**
 * RadiusConfig Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RadiusConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RadiusConfig';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['otp_pin_first'] === null) {
            $invalidProperties[] = "'otp_pin_first' can't be null";
        }
