...
/**
 * NewCustomerRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NewCustomerRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NewCustomerRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'quota_max' => 'int',
        'user_max' => 'int',
        'first_admin_user' => '\Swagger\Client\Model\FirstAdminUser',
        'company_name' => 'string',
        'trial_days' => 'int',
        'is_locked' => 'bool',
    ...
    protected static $setters = [
        ...
        'user_max' => 'setUserMax',
        'first_admin_user' => 'setFirstAdminUser',
    ...
    protected static $getters = [
        ...
        'user_max' => 'getUserMax',
        'first_admin_user' => 'getFirstAdminUser',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['first_admin_user'] = isset($data['first_admin_user']) ? $data['first_admin_user'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['first_admin_user'] === null) {
            $invalidProperties[] = "'first_admin_user' can't be null";
        }
    ...
    /**
     * Gets first_admin_user
     *
     * @return \Swagger\Client\Model\FirstAdminUser
     */
    public function getFirstAdminUser()
    {
        return $this->container['first_admin_user'];
    }

    /**
     * Sets first_admin_user
     *
     * @param \Swagger\Client\Model\FirstAdminUser $first_admin_user First admin user of a customer
     *
     * @return $this
     */
    public function setFirstAdminUser($first_admin_user)
    {
        $this->container['first_admin_user'] = $first_admin_user;
     ...
     *
     * @param string $activation_code `DEPRECATED`: Customer activation code string: * valid only for types `free` and `demo` * for `pay` customers it is empty
     *
     * @return $this
     */
