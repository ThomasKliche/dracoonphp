 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateOAuthClientRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateOAuthClientRequest';
    ...
    const GRANT_TYPES_IMPLICIT = 'implicit';
    const GRANT_TYPES_PASSWORD = 'password';
    const GRANT_TYPES_CLIENT_CREDENTIALS = 'client_credentials';
    const GRANT_TYPES_REFRESH_TOKEN = 'refresh_token';
    ...
    public function setGrantTypes($grant_types)
    {
        ...
        if (array_diff($grant_types, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'grant_types', must be one of '%s'",
                    implode("', '", $allowedValues)
                )
            );
        }
